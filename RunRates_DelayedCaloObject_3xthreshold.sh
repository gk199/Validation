...
rates_delayed_cluster.exe new Threshold3x_18pt7x3_nov2__/mh125__mx50__pl10000 $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl10000.root
echo " "
echo "LLP mh=125 GeV, ctau=1 m"
rates_delayed_cluster.exe new Threshold3x_18pt7x3_nov2__/mh125__mx50__pl1000_ $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl1000.root
echo " "
echo "LLP mh=125 GeV, ctau=0.5 m"
rates_delayed_cluster.exe new Threshold3x_18pt7x3_nov2__/mh125__mx50__pl500__ $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl500.root
echo " "
echo "QCD"
rates_delayed_cluster.exe new Threshold3x_18pt7x3_nov2__/QCD $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_QCD.root
echo " "
echo "Neutrino gun new and old conditions, note not processed with 3x threshold"
...
echo " "
echo " "
echo "Rates plots from draw_rates.exe, note not processed with 3x threshold"
draw_rates.exe
...
rates_delayed_cluster.exe new Threshold3x_18pt7x3_nov2__/mh1000_mx450_pl10000 $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl10000.root
echo " "
echo "LLP mh=1000 GeV, ctau=1 m"
rates_delayed_cluster.exe new Threshold3x_18pt7x3_nov2__/mh1000_mx450_pl1000_ $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl1000.root
echo " "
echo "LLP mh=1000 GeV, ctau=0.5 m"
rates_delayed_cluster.exe new Threshold3x_18pt7x3_nov2__/mh1000_mx450_pl500__ $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl500.root
echo " "
echo "Making overlay plots from draw_timingbit.exe"
draw_timingbit_delayed_cluster.exe
...
rates_delayed_cluster.exe new Threshold3x_18pt7x3_nov2__/mh350__mx160_pl10000 $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl10000.root
echo " "
echo "LLP mh=350 GeV, ctau=1 m"
rates_delayed_cluster.exe new Threshold3x_18pt7x3_nov2__/mh350__mx160_pl1000_ $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl1000.root
echo " "
echo "LLP mh=350 GeV, ctau=0.5 m"
rates_delayed_cluster.exe new Threshold3x_18pt7x3_nov2__/mh350__mx160_pl500__ $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl500.root
echo " "
echo "Making overlay plots from draw_timingbit.exe"
draw_timingbit_delayed_cluster.exe
...
rates_delayed_cluster.exe new Threshold3x_18pt7x3_nov2__/mh250__mx120_pl1000_ $1 $2 $3 $4 $5 $6
echo " "

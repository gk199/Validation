...
rates_FineGrain.exe new Time3Depth1/mh125__pl3000__PU $1 $2 $3 $4
mv rates_new_cond.root rates_new_cond_LLP_pl3000.root
echo " "
echo "LLP mh=125 GeV, ctau=30 m"
rates_FineGrain.exe new Time3Depth1/mh125__pl30000_PU $1 $2 $3 $4
mv rates_new_cond.root rates_new_cond_LLP_pl30000.root
echo " "
echo "QCD"
rates_FineGrain.exe new Time3Depth1/QCD_PU $1 $2 $3 $4
mv rates_new_cond.root rates_new_cond_QCD.root
echo " "
echo "Neutrino gun new and old conditions"
rates_FineGrain.exe new Time3Depth1/RelValNuGun $1 $2 $3 $4
rates_original.exe def Time3Depth1/RelValNuGun
echo " "
echo " "
...
rates_FineGrain.exe new Time3Depth1/mh250__pl500___PU $1 $2 $3 $4
mv rates_new_cond.root rates_new_cond_LLP_pl500.root
echo " "
echo "LLP mh=250 GeV, ctau=1 m"
rates_FineGrain.exe new Time3Depth1/mh250__pl1000__PU $1 $2 $3 $4
mv rates_new_cond.root rates_new_cond_LLP_pl1000.root
echo " "
echo "LLP mh=250 GeV, ctau=10 m"
rates_FineGrain.exe new Time3Depth1/mh250__pl10000_PU $1 $2 $3 $4
...
rates_FineGrain.exe new Time3Depth1/mh350__pl500___PU $1 $2 $3 $4
mv rates_new_cond.root rates_new_cond_LLP_pl500.root
echo " "
echo "LLP mh=350 GeV, ctau=1 m"
rates_FineGrain.exe new Time3Depth1/mh350__pl1000__PU $1 $2 $3 $4
mv rates_new_cond.root rates_new_cond_LLP_pl1000.root
echo " "
echo "LLP mh=350 GeV, ctau=10 m"
rates_FineGrain.exe new Time3Depth1/mh350__pl10000_PU $1 $2 $3 $4
mv rates_new_cond.root rates_new_cond_LLP_pl10000.root
echo " "
echo " "
echo "Making overlay plots from draw_timingbit.exe"
...
rates_FineGrain.exe new Time3Depth1/mh1000_pl10000_PU $1 $2 $3 $4
mv rates_new_cond.root rates_new_cond_LLP_pl10000.root
echo " "
echo "LLP mh=1000 GeV, ctau=100 m"
rates_FineGrain.exe new Time3Depth1/mh1000_pl100000PU $1 $2 $3 $4

...
rates_delayed_cluster.exe new mh125__pl3000__PU $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl3000.root
echo " "
echo "LLP mh=125 GeV, ctau=30 m"
rates_delayed_cluster.exe new mh125__pl30000_PU $1 $2 $3 $4 $5 $6
...
rates_delayed_cluster.exe new mh250__pl1000__PU $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl1000.root
echo " "
echo "LLP mh=250 GeV, ctau=10 m"
rates_delayed_cluster.exe new mh250__pl10000_PU $1 $2 $3 $4 $5 $6
...
rates_delayed_cluster.exe new mh350__pl1000__PU $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl1000.root
echo " "
echo "LLP mh=350 GeV, ctau=10 m"
rates_delayed_cluster.exe new mh350__pl10000_PU $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl10000.root
echo " "
echo " "
echo "Making overlay plots from draw_timingbit.exe"
...
rates_delayed_cluster.exe new mh1000_pl10000_PU $1 $2 $3 $4 $5 $6
mv rates_new_cond.root rates_new_cond_LLP_pl10000.root
echo " "
echo "LLP mh=1000 GeV, ctau=100 m"
rates_delayed_cluster.exe new mh1000_pl100000PU $1 $2 $3 $4 $5 $6

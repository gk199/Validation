...
void plotSpatialDist(int iEvent){
  ...
  TFile *f = TFile::Open("../PionGun_0_10GeV/211_00PU_timeslew-false_eta1phi0_caloSamples/L1Ntuple_211_E10_PU_00_eta1phi0_timeslew-false_step1_CaloSamples_100events.root","READ");

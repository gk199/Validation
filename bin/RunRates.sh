...
rates.exe new ../mh350__pl10000_mx160/
mv rates_new_cond.root rates_new_cond_pl10000_4L1Jets.root
echo " "
echo "LLP mh=350 GeV, ctau=1 m"
rates.exe new ../mh350__pl1000__mx160/
mv rates_new_cond.root rates_new_cond_pl1000_4L1Jets.root
echo " "
echo "LLP mh=350 GeV, ctau=0.5 m"
rates.exe new ../mh350__pl500___mx160/
mv rates_new_cond.root rates_new_cond_pl500_4L1Jets.root
echo " "
echo "Making overlay plots from draw_rates.exe"
draw_rates.exe
...
rates.exe new ../mh250__pl10000/
mv rates_new_cond.root rates_new_cond_pl10000_4L1Jets.root
echo " "
echo "LLP mh=250 GeV, ctau=1 m"
rates.exe new ../mh250__pl1000_/
mv rates_new_cond.root rates_new_cond_pl1000_4L1Jets.root
echo " "
echo "LLP mh=250 GeV, ctau=0.5 m"
rates.exe new ../mh250__pl500__/
mv rates_new_cond.root rates_new_cond_pl500_4L1Jets.root
echo " "
echo "Making overlay plots from draw_rates.exe"
draw_rates.exe
echo "Moving output plots to a new directory"
mv plots/* plots_DRaroundTPandL1_mh250/
echo " "
echo " "
echo "LLP mh=125 GeV, ctau=10 m"
rates.exe new ../mh125__pl10000/
mv rates_new_cond.root rates_new_cond_pl10000_4L1Jets.root
echo " "
echo "LLP mh=125 GeV, ctau=1 m"
rates.exe new ../mh125__pl1000_/
mv rates_new_cond.root rates_new_cond_pl1000_4L1Jets.root
echo " "
echo "LLP mh=125 GeV, ctau=0.5 m"
rates.exe new ../mh125__pl500__/
mv rates_new_cond.root rates_new_cond_pl500_4L1Jets.root
echo " "
echo "Making overlay plots from draw_rates.exe"
draw_rates.exe
echo "Moving output plots to a new directory"
mv plots/* plots_DRaroundTPandL1_mh125/
echo " "
echo " "

...
int main() {
  ...
  while (myReader.Next()){
	...
	if ( (detectorID.ieta() == ieta_withTDC[of_interest]) && (detectorID.iphi() == iphi_withTDC[of_interest]) && (detectorID.depth() == depth_withTDC[of_interest]) ) { // for looking at the pulse shape of a certain TDC value

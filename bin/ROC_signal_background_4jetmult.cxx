...
int main() {
  ...
  gr_120timingOR360_mh1000_pl10000_timescan->SetTitle("Signal Eff. vs Background Rejection with 4 Jet Hit Multiplicity Approach;Signal Eff (LLP, mh=1TeV, ctau=10m);QCD Rejection");
  ...
  legend_pl10000->AddEntry(gr_120timingOR360_mh125_pl10000_timescan,"mh = 125, 120+timing OR 360, nhits scanned");
  legend_pl10000->AddEntry(gr_120timingOR360_mh350_pl10000_timescan,"mh = 350, 120+timing OR 360, nhits scanned");
  legend_pl10000->AddEntry(gr_120timingOR360_mh1000_pl10000_timescan,"mh = 1000, 120+timing OR 360, nhits scanned");
  legend_pl10000->Draw();
  ROC_120timingOR360_pl10000->SaveAs("plots/ROC_4jet_120timingOR360_pl10000.pdf");
  ...
  gr_120timingOR360_mh1000_pl1000_timescan->SetTitle("Signal Eff. vs Background Rejection with 4 Jet Hit Multiplicity Approach;Signal Eff (LLP, ctau=1m);QCD Rejection");
  ...
  legend_pl1000->AddEntry(gr_120timingOR360_mh125_pl1000_timescan,"mh = 125, 120+timing OR 360, nhits scanned");
  legend_pl1000->AddEntry(gr_120timingOR360_mh250_pl1000_timescan,"mh = 250, 120+timing OR 360, nhits scanned");
  legend_pl1000->AddEntry(gr_120timingOR360_mh350_pl1000_timescan,"mh = 350, 120+timing OR 360, nhits scanned");
  legend_pl1000->AddEntry(gr_120timingOR360_mh1000_pl1000_timescan,"mh = 1000, 120+timing OR 360, nhits scanned");
  legend_pl1000->Draw();
  ROC_120timingOR360_pl1000->SaveAs("plots/ROC_4jet_120timingOR360_pl1000.pdf");
  ...
  gr_120timingOR360_mh1000_pl500_timescan->SetTitle("Signal Eff. vs Background Rejection with 4 Jet Hit Multiplicity Approach;Signal Eff (LLP, ctau=0.5m);QCD Rejection");
  ...
  legend_pl500->AddEntry(gr_120timingOR360_mh125_pl500_timescan,"mh = 125, 120+timing OR 360, nhits scanned");
  legend_pl500->AddEntry(gr_120timingOR360_mh350_pl500_timescan,"mh = 350, 120+timing OR 360, nhits scanned");
  legend_pl500->AddEntry(gr_120timingOR360_mh1000_pl500_timescan,"mh = 1000, 120+timing OR 360, nhits scanned");
  legend_pl500->Draw();
  ROC_120timingOR360_pl500->SaveAs("plots/ROC_4jet_120timingOR360_pl500.pdf");
  ...
  gr_120timing_mh1000_pl10000_timescan->SetTitle("Signal Eff. vs Background Rejection with 4 Jet Hit Multiplicity Approach;Signal Eff (LLP, mh=1TeV, ctau=10m);QCD Rejection");
  ...
  legend_120timing_pl10000->AddEntry(gr_120timing_mh125_pl10000_timescan,"mh = 125, 120+timing, nhits scanned");
  legend_120timing_pl10000->AddEntry(gr_120timing_mh350_pl10000_timescan,"mh = 350, 120+timing, nhits scanned");
  legend_120timing_pl10000->AddEntry(gr_120timing_mh1000_pl10000_timescan,"mh = 1000, 120+timing, nhits scanned");
  legend_120timing_pl10000->Draw();
  ROC_120timing_pl10000->SaveAs("plots/ROC_4jet_120timing_pl10000.pdf");
  ...
  gr_120timing_mh1000_pl1000_timescan->SetTitle("Signal Eff. vs Background Rejection with 4 Jet Hit Multiplicity Approach;Signal Eff (LLP, ctau=1m);QCD Rejection");
  ...
  legend_120timing_pl1000->AddEntry(gr_120timing_mh125_pl1000_timescan,"mh = 125, 120+timing, nhits scanned");
  legend_120timing_pl1000->AddEntry(gr_120timing_mh250_pl1000_timescan,"mh = 250, 120+timing, nhits scanned");
  legend_120timing_pl1000->AddEntry(gr_120timing_mh350_pl1000_timescan,"mh = 350, 120+timing, nhits scanned");
  legend_120timing_pl1000->AddEntry(gr_120timing_mh1000_pl1000_timescan,"mh = 1000, 120+timing, nhits scanned");
  legend_120timing_pl1000->Draw();
  ROC_120timing_pl1000->SaveAs("plots/ROC_4jet_120timing_pl1000.pdf");
  ...
  gr_120timing_mh1000_pl500_timescan->SetTitle("Signal Eff. vs Background Rejection with 4 Jet Hit Multiplicity Approach;Signal Eff (LLP, ctau=0.5m);QCD Rejection");
  ...
  legend_120timing_pl500->AddEntry(gr_120timing_mh125_pl500_timescan,"mh = 125, 120+timing, nhits scanned");
  legend_120timing_pl500->AddEntry(gr_120timing_mh350_pl500_timescan,"mh = 350, 120+timing, nhits scanned");
  legend_120timing_pl500->AddEntry(gr_120timing_mh1000_pl500_timescan,"mh = 1000, 120+timing, nhits scanned");
  legend_120timing_pl500->Draw();
  ROC_120timing_pl500->SaveAs("plots/ROC_4jet_120timing_pl500.pdf");

...
int main()
{
  ...
  for(auto multType : multTypes) {
    ...
    multHists_LLPpl3000[multType] = dynamic_cast<TH1F*>(files.at(2)->Get(histName.c_str()));
    multHists_LLPpl30000[multType] = dynamic_cast<TH1F*>(files.at(3)->Get(histName.c_str()));
  }

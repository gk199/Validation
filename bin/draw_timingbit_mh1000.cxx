...
int main()
{
  ...
  for(auto multType : multTypes) {
    ...
    multHists_LLPpl10000[multType] = dynamic_cast<TH1F*>(files.at(2)->Get(histName.c_str()));
    multHists_LLPpl100000[multType] = dynamic_cast<TH1F*>(files.at(3)->Get(histName.c_str()));
  }

...
int main()
{
  ...
  histColor["tripleJet"] = histColor["doubleEg"] = histColor["doubleTau"] = histColor["dt3GeV3ns"] = histColor["dt3GeV3nsHE"] = histColor["dt3GeV3nsHB"] = histColor["dt2GeV3ns"] = histColor["dt1GeV3ns"] =histColor["dt2GeV3nsHE"] = histColor["dt1GeV3nsHE"] = histColor["dt2GeV3nsHB"] = histColor["dt1GeV3nsHB"] = histColor["dt3GeV3nsJet"] = histColor["dt3GeV3nsHEJet"] = histColor["dt3GeV3nsHBJet"] = histColor["dt2GeV3nsJet"] = histColor["dt1GeV3nsJet"] =histColor["dt2GeV3nsHEJet"] = histColor["dt1GeV3nsHEJet"] = histColor["dt2GeV3nsHBJet"] = histColor["dt1GeV3nsHBJet"]  = kGreen;
  ...
  for (auto iplot : mult_plots){
	...
	multHists_QCD[hist]->Rebin(rebinFactor*2);
      ...
      multHists_QCD[hist]->SetTitle("Multiplicity for QCD, timing scan at " + name(2,4) + name(9,3));
      ...
      if ( name(9,2) == "HE" || name(9,2) == "HB" ){
        multHists_QCD[hist]->SetTitle("Multiplicity for QCD, timing scan at " + name(2,4) + " in " + name(9,2) + name(11,3));
	...
	multHists_QCD[hist]->GetXaxis()->SetRangeUser(0,20);
      }
  ...
  for (auto iplot : mult_plots){
    ...
    for (auto hist : iplot.second) {
      ...
      multHists_LLP10000[hist]->SetTitle("Multiplicity for LLP c#scale[1.2]{#tau}=10m, timing scan at " + name(2,4) + name(9,3));
      ...
      if ( name(9,2) == "HE" || name(9,2) == "HB" ){
	multHists_LLP10000[hist]->SetTitle("Multiplicity for LLP c#scale[1.2]{#tau}=10m, timing scan at " + name(2,4) + " in " + name(9,2) + name(11,3)); 
	...
	if (hist.substr(0,3) == "dt3" && name(9,2) == "HB" ) multHists_LLP10000[hist]->GetXaxis()->SetRangeUser(0,50);
      ...
      if ( name(11,3) == "Jet" || name(9,3) == "Jet" ) { // reduce x axis range for plots where HCAL TP has been matched to L1 Jet      
	multHists_LLP10000[hist]->GetXaxis()->SetRangeUser(0,20);
      }
  ...
  for (auto iplot : mult_plots){
    ...
    for (auto hist : iplot.second) {
      ...
      multHists_LLP1000[hist]->SetTitle("Multiplicity for LLP c#scale[1.2]{#tau}=1m, timing scan at " + name(2,4) + name(9,3));
      ...
      if ( name(9,2) == "HE" || name(9,2) == "HB" ){
        multHists_LLP1000[hist]->SetTitle("Multiplicity for LLP c#scale[1.2]{#tau}=1m, timing scan at " + name(2,4) + " in " + name(9,2) + name(11,3));
	...
	if (hist.substr(0,3) == "dt1" && name(9,2) == "HB" ) multHists_LLP1000[hist]->GetXaxis()->SetRangeUser(0,100);
      ...
      if ( name(11,3) == "Jet" || name(9,3) == "Jet" ) { // reduce x axis range for plots where HCAL TP has been matched to L1 Jet                             
	multHists_LLP1000[hist]->GetXaxis()->SetRangeUser(0,20);
      }
  ...
  for (auto iplot : mult_plots){
    ...
    for (auto hist : iplot.second) {
      ...
      multHists_LLP500[hist]->SetTitle("Multiplicity for LLP c#scale[1.2]{#tau}=0.5m, timing scan at " + name(2,4) + name(9,3));
      ...
      if ( name(9,2) == "HE" || name(9,2) == "HB" ){
        multHists_LLP500[hist]->SetTitle("Multiplicity for LLP c#scale[1.2]{#tau}=0.5m, timing scan at " + name(2,4) + " in region " + name(9,2) + name(11,3));
	...
	if (hist.substr(0,3) == "dt1" && name(9,2) == "HB" ) multHists_LLP500[hist]->GetXaxis()->SetRangeUser(0,100);
      ...
      if ( name(11,3) == "Jet" || name(9,3) == "Jet" ) { // reduce x axis range for plots where HCAL TP has been matched to L1 Jet              
	multHists_LLP500[hist]->GetXaxis()->SetRangeUser(0,20);
      }
  ...
  for (auto hist : multTypes ) {
    ...
    if (name(0,5) != "Ratio") {
      ...
      multHists_QCD[hist]->GetYaxis()->SetRangeUser(0,1.2*yMax);
      if (name(6,3) == "1ns"){
     	multHists_QCD[hist]->GetYaxis()->SetRangeUser(0,400);
      }
    }
    ...
    multHists_QCD[hist]->SetTitle("Multiplicity Overlay of QCD and LLPs at " + name(2,4) + " and " + name(6,3) + name (9,3));
    if (name(9,3) != "Jet" ) multHists_QCD[hist]->SetTitle("Multiplicity Overlay of QCD and LLPs at " + name(2,4) + " and " + name(6,3));
    multHists_QCD[hist]->GetYaxis()->CenterTitle(true);
    if ( name(9,2) == "HE" || name(9,2) == "HB" ){
      multHists_QCD[hist]->SetTitle("Multiplicity Overlay of QCD and LLPs at " + name(2,4) + " and " + name(6,3) + " in " + name(9,2) + name(11,3));
      if (name(11,3) != "Jet" ) multHists_QCD[hist]->SetTitle("Multiplicity Overlay of QCD and LLPs at " + name(2,4) + " and " + name(6,3) + " in " + name(9,2));
      if (hist.substr(0,3) == "dt1" && name(9,2) == "HB" ) multHists_QCD[hist]->GetXaxis()->SetRangeUser(0,100);
      if (hist.substr(0,3) == "dt2" && name(9,2) == "HB" ) multHists_QCD[hist]->GetXaxis()->SetRangeUser(0,70);
      if (hist.substr(0,3) == "dt3" && name(9,2) == "HB" ) multHists_QCD[hist]->GetXaxis()->SetRangeUser(0,50);
    }

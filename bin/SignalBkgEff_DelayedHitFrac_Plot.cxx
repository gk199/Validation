...
int main() {
  ...
  Signal_mh350_pl1000.open("DelayedHitFrac_Signal_mh350_pl100.txt");
  n = 0;
  ...
  Signal_mh350_pl500.open("DelayedHitFrac_Signal_mh350_pl500.txt");
  n = 0;
  ...
  Signal_mult_mh350_pl1000.open("MultiplicityHits3GeV3ns_Signal_mh350_pl100.txt");
  n = 0;
  ...
  Signal_mult_mh350_pl500.open("MultiplicityHits3GeV3ns_Signal_mh350_pl500.txt");
  n = 0;
  ...
  gr_1GeV_mh1000_pl1000_timescan->Draw("AC*");
  gr_1GeV_mh1000_pl1000_timescan->GetXaxis()->SetLimits(0.,1.1);
  gr_1GeV_mh1000_pl1000_timescan->GetHistogram()->SetMaximum(1.1);
  gr_1GeV_mh1000_pl1000_timescan->GetHistogram()->SetMinimum(0.);
  gr_1GeV_mh1000_pl1000_timescan->SetTitle("Signal Eff. vs Background Rejection with Delayed Hit Fraction > 0.5, 2 leading L1 jets;Signal Eff (LLP, mh=1TeV, ctau=1m);QCD Rejection");
  gr_2GeV_mh1000_pl1000_timescan->SetLineColor(4); // blue
  gr_2GeV_mh1000_pl1000_timescan->Draw("C*");
  ...
  legend_mh1000_pl1000->AddEntry(gr_1GeV_mh1000_pl1000_timescan,"1 GeV, TDC scanned");
  ...
  gr_1GeV_mh1000_pl500_timescan->Draw("AC*");
  gr_1GeV_mh1000_pl500_timescan->GetXaxis()->SetLimits(0.,1.1);
  gr_1GeV_mh1000_pl500_timescan->GetHistogram()->SetMaximum(1.1);
  gr_1GeV_mh1000_pl500_timescan->GetHistogram()->SetMinimum(0.);
  gr_1GeV_mh1000_pl500_timescan->SetTitle("Signal Eff. vs Background Rejection with Delayed Hit Fraction > 0.5, 2 leading L1 jets;Signal Eff (LLP, mh=1TeV, ctau=0.5m);QCD Rejection");
  gr_2GeV_mh1000_pl500_timescan->SetLineColor(4); // blue
  gr_2GeV_mh1000_pl500_timescan->Draw("C*");
  ...
  legend_mh1000_pl500->AddEntry(gr_1GeV_mh1000_pl500_timescan,"1 GeV, TDC scanned");
  legend_mh1000_pl500->AddEntry(gr_2GeV_mh1000_pl500_timescan,"2 GeV, TDC scanned");
  legend_mh1000_pl500->AddEntry(gr_3GeV_mh1000_pl500_timescan,"3 GeV, TDC scanned");
  legend_mh1000_pl500->AddEntry(gr_4GeV_mh1000_pl500_timescan,"4 GeV, TDC scanned");
  ...
  gr_1GeV_mh350_pl1000_timescan->Draw("AC*");
  gr_1GeV_mh350_pl1000_timescan->GetXaxis()->SetLimits(0.,1.1);
  gr_1GeV_mh350_pl1000_timescan->GetHistogram()->SetMaximum(1.1);
  gr_1GeV_mh350_pl1000_timescan->GetHistogram()->SetMinimum(0.);
  gr_1GeV_mh350_pl1000_timescan->SetTitle("Signal Eff. vs Background Rejection with Delayed Hit Fraction > 0.5, 2 leading L1 jets;Signal Eff (LLP, mh=350GeV, ctau=1m);QCD Rejection");
  gr_2GeV_mh350_pl1000_timescan->SetLineColor(4); // blue
  gr_2GeV_mh350_pl1000_timescan->Draw("C*");
  ...
  legend_mh350_pl1000->AddEntry(gr_1GeV_mh350_pl1000_timescan,"1 GeV, TDC scanned");
  legend_mh350_pl1000->AddEntry(gr_2GeV_mh350_pl1000_timescan,"2 GeV, TDC scanned");
  legend_mh350_pl1000->AddEntry(gr_3GeV_mh350_pl1000_timescan,"3 GeV, TDC scanned");
  legend_mh350_pl1000->AddEntry(gr_4GeV_mh350_pl1000_timescan,"4 GeV, TDC scanned");
  ...
  gr_1GeV_mh350_pl500_timescan->Draw("AC*");
  gr_1GeV_mh350_pl500_timescan->GetXaxis()->SetLimits(0.,1.1);
  gr_1GeV_mh350_pl500_timescan->GetHistogram()->SetMaximum(1.1);
  gr_1GeV_mh350_pl500_timescan->GetHistogram()->SetMinimum(0.);
  gr_1GeV_mh350_pl500_timescan->SetTitle("Signal Eff. vs Background Rejection with Delayed Hit Fraction > 0.5, 2 leading L1 jets;Signal Eff (LLP, mh=350GeV, ctau=0.5m);QCD Rejection");
  gr_2GeV_mh350_pl500_timescan->SetLineColor(4); // blue
  gr_2GeV_mh350_pl500_timescan->Draw("C*");
  ...
  legend_mh350_pl500->AddEntry(gr_1GeV_mh350_pl500_timescan,"1 GeV, TDC scanned");
  legend_mh350_pl500->AddEntry(gr_2GeV_mh350_pl500_timescan,"2 GeV, TDC scanned");
  legend_mh350_pl500->AddEntry(gr_3GeV_mh350_pl500_timescan,"3 GeV, TDC scanned");
  legend_mh350_pl500->AddEntry(gr_4GeV_mh350_pl500_timescan,"4 GeV, TDC scanned");
  ...
  legend2_mh1000_pl1000->AddEntry(gr_3GeV_mh1000_pl1000_timescan,"Delayed Hit Frac>0.5, 2 leading L1 jets and above 3GeV, TDC scanned");
  ...
  legend2_mh1000_pl500->AddEntry(gr_3GeV_mh1000_pl500_timescan,"Delayed Hit Frac>0.5, 2 leading L1 jets and above 3GeV, TDC scanned");
  ...
  gr_3GeV_mh350_pl1000_timescan->SetLineColor(3); // green
  gr_3GeV_mh350_pl1000_timescan->Draw("AC*");
  gr_3GeV_mh350_pl1000_timescan->GetXaxis()->SetLimits(0.,1.1);
  gr_3GeV_mh350_pl1000_timescan->GetHistogram()->SetMaximum(1.1);
  gr_3GeV_mh350_pl1000_timescan->GetHistogram()->SetMinimum(0.);
  gr_3GeV_mh350_pl1000_timescan->SetTitle("Signal Eff. vs Background Rejection;Signal Eff (LLP, mh=350GeV, ctau=1m);QCD Rejection");
  ...
  legend2_mh350_pl1000->AddEntry(gr_3GeV_mh350_pl1000_timescan,"Delayed Hit Frac>0.5, 2 leading L1 jets and above 3GeV, TDC scanned");
  ...
  gr_3GeV_mh350_pl500_timescan->SetLineColor(3); // green
  gr_3GeV_mh350_pl500_timescan->Draw("AC*");
  gr_3GeV_mh350_pl500_timescan->GetXaxis()->SetLimits(0.,1.1);
  gr_3GeV_mh350_pl500_timescan->GetHistogram()->SetMaximum(1.1);
  gr_3GeV_mh350_pl500_timescan->GetHistogram()->SetMinimum(0.);
  gr_3GeV_mh350_pl500_timescan->SetTitle("Signal Eff. vs Background Rejection;Signal Eff (LLP, mh=350GeV, ctau=0.5m);QCD Rejection");
  ...
  legend2_mh350_pl500->AddEntry(gr_3GeV_mh350_pl500_timescan,"Delayed Hit Frac>0.5, 2 leading L1 jets and above 3GeV, TDC scanned");

...
void rates(bool newConditions, const std::string& inputFileDirectory){
  ...
  for (Long64_t jentry=0; jentry<nentries; jentry++){
	...
	if (jetIt == 0) DeltaR_partons_L1Jet_1->Fill(min_deltaR_partonGen_L1jet); // minimum deltaR plot of distance between L1 jet 1 and all partons passing cuts
	...
	if (jetIt == 0) DeltaR_partonsHCAL_L1Jet_1->Fill(min_deltaR_partonGenHCAL_L1jet); // minimum deltaR plot of distance between L1 jet 1 and all partons passing cuts that have a vertex in the HCAL volume

...
int main()
{
  ...
  std::vector<std::string> multTypes = {"Delayed_2x2_MultHB","Prompt_2x2_MultHB","Prompt_Energy_2x2_MultHB","HTdistribution","HTdistribution_trig","DeltaR_L1_delayed_seed","DeltaR_L1_prompt_seed","DeltaR_L1_delayed_hit","DeltaR_L1_prompt_hit","Mult_delayed_hit","Mult_prompt_hit"}; // list the names of the TH1Fs that will be overlayed

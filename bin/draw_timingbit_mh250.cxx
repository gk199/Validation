...
int main()
{
  ...
  for(auto hist : multTypes) {
    ...
    leg->AddEntry(multHists_LLPpl500[hist], "LLP, mh=250 GeV, c#scale[1.2]{#tau}=0.5m", "L");
    leg->AddEntry(multHists_LLPpl1000[hist], "LLP, mh=250 GeV, c#scale[1.2]{#tau}=1m", "L");
    leg->AddEntry(multHists_LLPpl10000[hist], "LLP, mh=250 GeV, c#scale[1.2]{#tau}=10m", "L");

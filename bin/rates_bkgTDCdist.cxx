...
void rates_delayed_cluster(bool newConditions, const std::string& inputFileDirectory, double GeV_HB_variable, double GeV_HE_variable){
  ...
  if (inputFile.substr(71,3) == "QCD" ) {
    ...
    std::ofstream TDCdistribution_Background;
    std::ofstream TDCdistribution_Background95;
    TDCdistribution_Background.open(Form("TDCdistribution_Background_%s.txt",inputFile.substr(89,29).c_str()));
    TDCdistribution_Background95.open(Form("TDCdistribution_Background95_%s.txt",inputFile.substr(89,29).c_str()));

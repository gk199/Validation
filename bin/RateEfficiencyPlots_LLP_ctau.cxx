...
int main() {
  ...
  gr_background->SetTitle("Rate vs. Background Efficiency for >=1,2 Delayed Objects;Added QCD Efficiency, c#scale[1.2]{#tau}=0.5m;Neutrino Gun Rate (Hz, unnormalized)   ");

...
void efficiency_TOF_combined(){
  ...
  h1->SetTitle("Delayed Jet TOF Delay Efficiency");
  ...
  char saveFile[100];
  sprintf(saveFile,"/eos/user/g/gkopp/www/HCAL_LLP/TimingBit/112X_TDCsim_DelayedJet/TOFefficiency_4combined.pdf");
  c1->SaveAs(saveFile);

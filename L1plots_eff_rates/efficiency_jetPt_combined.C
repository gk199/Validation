...
void efficiency_jetPt_combined(){
  ...
  h1->SetTitle("Delayed Jet Efficiency vs Jet E_{T}");
  ...
  legend1->AddEntry(pEff1, "Delayed L1 jet", "l");
  legend1->AddEntry(pEff2, "Delayed L1 jet, and event HT>120", "l");

  legend1->Draw("same");

  char saveFile[100];
  sprintf(saveFile,"/eos/user/g/gkopp/www/HCAL_LLP/TimingBit/112X_TDCsim_DelayedJet/L1Jetefficiency_4combined.pdf");
  c1->SaveAs(saveFile);

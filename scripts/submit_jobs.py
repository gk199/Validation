...
CALOSTAGE2PARAMS = '2018_v1_4'
# dummy value needed so that cmsDriver.py will
# assume that there is an input file
DEFAULTINPUT = '/store/relval/CMSSW_10_6_1_patch1/RelValNuGun/GEN-SIM-DIGI-RAW/PU_106X_mcRun3_2021_realistic_v3_rsb-v2/20000/1C14A4C8-A1F9-EE43-93EB-EAD32B0EDF0F.root'
...
#    crab_submit_script.write("LUMIMASK = '" + ARGS.lumimask + "'\n")
    ...
    filename = 'submit_run_' + 'MCneutrino_gun' + '_' + jobtype + '.py'

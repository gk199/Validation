...
rates.exe new GeV3_ADC50_ADC105_AllDepth/mh125__mx50__pl10000
mv rates_new_cond.root rates_new_cond_LLP_pl10000.root
echo " "
echo "LLP mh=125 GeV, ctau=1 m"
rates.exe new GeV3_ADC50_ADC105_AllDepth/mh125__mx50__pl1000_
mv rates_new_cond.root rates_new_cond_LLP_pl1000.root
echo " "
echo "LLP mh=125 GeV, ctau=0.5 m"
rates.exe new GeV3_ADC50_ADC105_AllDepth/mh125__mx50__pl500__
mv rates_new_cond.root rates_new_cond_LLP_pl500.root
echo " "
echo "QCD"
rates.exe new GeV3_ADC50_ADC105_AllDepth/QCD
mv rates_new_cond.root rates_new_cond_QCD.root
echo " "
echo "Neutrino gun new and old conditions"
rates.exe new GeV3_ADC50_ADC105_AllDepth/NeutrinoGun
rates_original.exe def GeV3_ADC50_ADC105_AllDepth/NeutrinoGun
echo " "
echo " "
...
rates.exe new GeV3_ADC50_ADC105_AllDepth/mh1000_mx450_pl10000
mv rates_new_cond.root rates_new_cond_LLP_pl10000.root
echo " "
echo "LLP mh=1000 GeV, ctau=1 m"
rates.exe new GeV3_ADC50_ADC105_AllDepth/mh1000_mx450_pl1000_
mv rates_new_cond.root rates_new_cond_LLP_pl1000.root
echo " "
echo "LLP mh=1000 GeV, ctau=0.5 m"
rates.exe new GeV3_ADC50_ADC105_AllDepth/mh1000_mx450_pl500__
mv rates_new_cond.root rates_new_cond_LLP_pl500.root
echo " "
echo "Making overlay plots from draw_timingbit.exe"
draw_timingbit.exe
...
rates.exe new GeV3_ADC50_ADC105_AllDepth/mh350__mx160_pl10000
mv rates_new_cond.root rates_new_cond_LLP_pl10000.root
echo " "
echo "LLP mh=350 GeV, ctau=1 m"
rates.exe new GeV3_ADC50_ADC105_AllDepth/mh350__mx160_pl1000_
mv rates_new_cond.root rates_new_cond_LLP_pl1000.root
echo " "
echo "LLP mh=350 GeV, ctau=0.5 m"
rates.exe new GeV3_ADC50_ADC105_AllDepth/mh350__mx160_pl500__
mv rates_new_cond.root rates_new_cond_LLP_pl500.root
echo " "
echo "Making overlay plots from draw_timingbit.exe"
draw_timingbit.exe
mv rates_new_cond_LLP_pl1000.root rates_new_cond_LLP_mh350_pl1000.root
mv plots/ADC50_3ns_4JetMultHBOverlay.pdf /eos/user/g/gkopp/www/HCAL_LLP/TimingBit/ADC50_3ns/ADC50_3ns_4JetMultHBOverlay_mh350.pdf
mv plots/ADC50_3ns_4JetMultHEOverlay.pdf /eos/user/g/gkopp/www/HCAL_LLP/TimingBit/ADC50_3ns/ADC50_3ns_4JetMultHEOverlay_mh350.pdf
mv plots/ADC50_3ns_4JetMultHBHEOverlay.pdf /eos/user/g/gkopp/www/HCAL_LLP/TimingBit/ADC50_3ns/ADC50_3ns_4JetMultHBHEOverlay_mh350.pdf
echo " "
echo "LLP mh=250 GeV, ctau=1 m"
rates.exe new GeV3_ADC50_ADC105_AllDepth/mh250__mx120_pl1000_
...
mv /eos/user/g/gkopp/www/HCAL_LLP/TimingBit/EffRate* /eos/user/g/gkopp/www/HCAL_LLP/TimingBit/ADC50_3ns/
